<%@ Page Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="CreditRequest.aspx.cs" Inherits="CreditCalculator.Web.Areas.User.Credit" %>

<asp:Content ID="crediIndex" class="bankIndex" ContentPlaceHolderID="UserContent" runat="server">
    <div class="user-credit-requests-wrapper">
        ...
        <div class="user-calculator">
            <div class="calculator-wrapper">
                ...
                <div class="credit-title-wrapper mx-2">
                    <span class="page-title-text">Credit</span>
                </div>
                <div id="sendCreditWrapper">
                    <div class="credit-calculator-currency">
                    ...
                    <div class="credit-calculator-content">

                        <div class="calculator-compute-credit-wrapper">
                        </div>
    ...
    <script src="../../Scripts/User/CreditCalculator.js"></script>
</asp:Content>
