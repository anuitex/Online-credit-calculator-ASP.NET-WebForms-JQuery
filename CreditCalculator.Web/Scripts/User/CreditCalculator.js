...
$(document).ready(function () {
    _currency = 'dollar';
    $('.credit-calculator-currency [data-class-currency=fa-dollar-sign] i').addClass('active');
    $('.credit-calculator-content .selected-currency-span i').addClass('fa-dollar-sign fas');
});


function selectCurrency(e) {
    $('.credit-calculator-currency').find('.currency-icon').removeClass('active');
    $(e).find('.currency-icon').addClass('active');
    $('.credit-calculator-content .selected-currency-span i').removeClass().addClass(e.getAttribute('data-class-currency') + ' fas');

    _currency = e.getAttribute('data-currency');
}

function sendOrder() {
    var form = $('#sendCreditWrapper');
    var rateValue = $(form).find('div .money-rate-wrapper .show-money-rate-value-span')[0].textContent;
    var getMoney = $(form).find('div .money-get-quantity-wrapper .show-money-span')[0].textContent;
    ...
    $.ajax({
        type: "POST",
        url: "CreditRequest.aspx/AddCreditRequest",
